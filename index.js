...
var onHeaders = require('on-headers');//added to trigger cookie generation //wz
...
module.exports = function (options) {
    ...
    return function parseExpressCookieSession(req, res, next) {
        ...
        //var encryptionSecret = Parse.Cloud._expressCookieEncryptionKey(); /// commented by wz
        ...
        ////////////////////////
        // Response path logic
        onHeaders(res,/*res.on('header',*/ function () {///////////////////updated by wz
